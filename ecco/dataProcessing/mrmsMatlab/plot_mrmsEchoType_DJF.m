...
set(gcf,'PaperPositionMode','auto')
print(f1,[figdir,'categories_percentOfTotalCounts_DJF.png'],'-dpng','-r0');
...
set(gcf,'PaperPositionMode','auto')
print(f1,[figdir,'categories_percentOfValidCounts_DJF.png'],'-dpng','-r0');
...
for ii=1:length(cats)
    ...
    set(gcf,'PaperPositionMode','auto')
    print(f1,[figdir,cats{ii},'_percentOfValidCounts_00-12ST_DJF.png'],'-dpng','-r0');
...
for ii=1:length(cats)
    ...
    set(gcf,'PaperPositionMode','auto')
    print(f1,[figdir,cats{ii},'_percentOfValidCounts_12-00ST_DJF.png'],'-dpng','-r0');
...
for ii=1:length(cats)
    ...
    set(gcf,'PaperPositionMode','auto')
    print(f1,[figdir,cats{ii},'_percentOfValidCounts_fourDaily_DJF.png'],'-dpng','-r0');
