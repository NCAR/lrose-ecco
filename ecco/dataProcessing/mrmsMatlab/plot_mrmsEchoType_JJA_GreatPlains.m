...
figdir=['/scr/cirrus2/rsfdata/projects/nexrad-mrms/figures/eccoStats/JJA_GreatPlains/'];
...
terrain=ncread([indir,inList{1}],'TerrainHt');
...
hold on
geoshow(states,'FaceColor',[1,1,1],'facealpha',0,'DefaultEdgeColor',[0.5,0.5,0.5]);
%geoshow(countries,'FaceColor',[1,1,1],'facealpha',0);
contour(data.lon,data.lat,terrain',1000:1000:4000,'-k');
